...
from settings import DEFAULT_DORAEMON_LLM_CFG, DEFAULT_FUNCS, DEFAULT_MEMORY_CFG


class DoraemonClient(BaseClient):
    def __init__(self, parent=None, **kwargs):
        super().__init__(parent)

    def init_model(self, agent: Optional[DoraemonAgent] = None):
        self.agent = agent or DoraemonAgent(
            function_list=DEFAULT_FUNCS,
            llm=DEFAULT_DORAEMON_LLM_CFG,
