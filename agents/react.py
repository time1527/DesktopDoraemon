...
class ReAct(BaseAgent):
    ...
    def _format_react_messages(self,
    ...
    def _run(self, 
        ...
        while num_llm_calls_available > 0:
            ...
            for output in self._call_llm(messages=text_messages):
                if output:
                    yield [Message(role=MessageRole.ASSISTANT, content=response + output[-1].content)]
            ...
            if action_input.startswith('```'):
                ...
                action_input = '\n' + action_input
            text_messages[-1].content += thought + f'{REACT_TOOL_TOKEN} {action}{REACT_ARGS_TOKEN} {action_input}' + observation