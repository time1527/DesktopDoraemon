...
from utils.schema import MessageRole,Message,ContentItem,DEFAULT_SYSTEM_PROMPT,ROLE,CONTENT
    ...
    def _call_llm(self,
        ...
        if self.system_prompt:
            ...
            if messages[0][ROLE] != MessageRole.SYSTEM:
                messages.insert(0, Message(role=MessageRole.SYSTEM, content=self.system_prompt))
            ...
            # messages[0]的role是system 且 content是list: content前加上ContentItem形式的system_prompt
                ...
                messages[0][CONTENT] = [ContentItem(text=self.system_prompt + '\n\n')] + messages[0][CONTENT]
        # 2. llm调用
